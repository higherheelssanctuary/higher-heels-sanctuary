...
const INSTAGRAM_URL = "https://www.instagram.com/alfonsoklick/";
          ...
          <div>
            ...
            >
              ...
              <a
                ...
                className="mt-5 inline-flex items-center justify-center gap-2.5 h-13 w-full sm:w-auto px-8 py-3.5 rounded-sm text-white text-lg transition-all hover:scale-[1.02] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C13584] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A]"
                style={{
                  fontFamily: "var(--font-bebas-neue)",
                  letterSpacing: "0.1em",
                  background: "linear-gradient(90deg, #F58529 0%, #DD2A7B 50%, #8134AF 100%)",
                  boxShadow: "0 0 30px rgba(221,42,123,0.45)",
                }}
                aria-label="Escríbele a Alfonso en Instagram (@alfonsoklick)"
              >
